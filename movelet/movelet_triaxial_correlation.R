...
##Apply movelet method using triaxial data and correlation distance metric
...
##Filepath for plots
filepath_plots <- paste("~/Documents/data/ACSGA/analysis/movelet/results/triaxial_correlation/", subject, sep = "")
