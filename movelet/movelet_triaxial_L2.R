...
##Apply movelet method using tri-axial data and L2 distance metric 
...
##Filepath for plots
filepath_plots <- paste("~/Documents/data/ACSGA/analysis/movelet/results/standard/", subject, sep = "")
