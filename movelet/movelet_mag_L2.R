...
##Apply movelet method with magnitude data and L2 distance metric 
...
##Filepath for plots
filepath_plots <- paste("~/Documents/data/ACSGA/analysis/movelet/results/magnitude/", subject, sep = "")
